...
import github from '../../../../../static/images/icons/stack/github.svg';
...
import nodejs from '../../../../../static/images/icons/stack/nodejs-icon.svg';
...
export const projectData = [
  ...
  },
  {
    ...
    backendNames: ['Ruby', 'Rails', 'PostgreSQL'],
    testNames: null,
  ...
  },
  {
    ...
    backend: [rails, stripe, postgresql],
    test: null,
    deployment: null,
    frontendNames: ['Ruby', 'Bootstrap'],
    backendNames: ['Rails', 'Stripe', 'PostgreSQL'],
    testNames: null,
  ...
  },
  {
    ...
    backend: [nodejs, express, postgresql, websocket],
    test: [jest, cypress],
    deployment: [netlify, heroku, circleci],
    frontendNames: ['React', 'JavaScript', 'CSS3', 'materialui'],
    backendNames: ['NodeJS', 'ExpressJS', 'PostgreSQL', 'Websocket'],
    testNames: [],
  ...
  },
  {
    ...
    demo: '',
    frontend: [jquery, js, css3, sass, bootstrap],
    backend: [nodejs, express, postgresql],
    test: null,
    deployment: null,
    frontendNames: ['jQuery', 'JavaScript', 'CSS3', 'SASS', 'Bootstrap'],
    backendNames: ['NodeJS', 'ExpressJS', 'PostgreSQL'],
    testNames: null,
    deploymentNames: null,
  },
  {
    ...
    frontend: [react, html5, js, css3],
    backend: null,
    test: null,
    deployment: [github],
    frontendNames: ['React', 'HTML5', 'JavaScript', 'CSS3'],
    backendNames: null,
    testNames: null,
    deploymentNames: ['Github Pages'],
  },
  {
  ...
  },
  {
    ...
    test: null,
    deployment: [netlify],
    frontendNames: ['HTML5', 'CSS3', 'JavaScript', 'jQuery'],
    backendNames: null,
    testNames: null,
    deploymentNames: ['Netlify'],
  },
