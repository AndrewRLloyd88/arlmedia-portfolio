...
export const projectData = [
  {
    ...
    test: null,
    deployment: [netlify],
    frontendNames: ['React', 'TypeScript', 'CSS3'],
    backendNames: ['PostgreSQL'],
    testNames: null,
  ...
  },
  {
    ...
    description:
      'An informational site analyzing SpaceX launches and rockets built for Mintbean’s career accelerator program using the R-SpaceX Api.',
    image: '/images/projects/spacex.jpg',
    github: 'https://github.com/AndrewRLloyd88/mb-career-accelerator-spaceX',
    demo: 'https://spacexploration-mb.netlify.app/',
  ...
  },
  {
    ...
    description:
      'A playable and modifiable synth with approximately 30 patches using the ToneJS library made for Mintbean’s synthesizer hackathon.',
    image: '/images/projects/expressivesynth.jpg',
    github: 'https://github.com/AndrewRLloyd88/Expressive-Synth',
    demo: 'https://expressive-synth.netlify.app/',
    frontend: [react, typescript, css3, materialui],
    backend: null,
    test: null,
    deployment: [netlify],
